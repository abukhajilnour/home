...
ActiveRecord::Schema.define(version: 20140903061459) do
  ...
  create_table "idea_details", force: true do |t|
    t.text     "notes"
    t.integer  "idea_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "idea_details", ["idea_id"], name: "index_idea_details_on_idea_id", using: :btree
  ...
  add_index "remarks", ["comment_id"], name: "index_remarks_on_comment_id", using: :btree
